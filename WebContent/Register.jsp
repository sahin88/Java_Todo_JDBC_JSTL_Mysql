...
<body>
	...
	<div class="login__div">
		...
		<h3>Create  an Account and Sign Up!</h3>
			E-mail:<input type='text' name="username">
			Password:<input type='password' name="password">
			Password 2:<input type='password' name="password2">
			<input type="submit"/>
			<span><a  class="return_signin"href="Login.jsp"> Already an account? Sign in!</a></span>
		</form>
	</div>
